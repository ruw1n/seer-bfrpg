...
If you need deeper mechanics (AC calculation quirks, stoneskin timers, special resistances, etc.), ask the bot `!help <command>` in‑server or inspect the project’s `*.py` cogs.
